...
public class Constants {
    ...
    public static final double kEpsilson = 0.0001;

    public static final double kWristGravityComponentMultiplier = 0.0; //TODO TUNE THESE
    public static final double kWristAccelerationMultiplier = 0.0;
    public static final double kWristElevatorAccelerationMultiplier = 0.0;
    public static final double kWristDrivetrainAccelerationMultiplier = 0.0;
}